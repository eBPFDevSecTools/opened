...
/* 
 ...
 Read_maps: [ stats,] 
 Update_maps: [] 
 Func Description: Check how many connection have been made within the last one second(or other
 predefined value), function will return true if it's exceding the max connection rate and false
 otherwise.
 OPENED COMMENT END 
 */ 
...
/* 
 ...
 Update_maps: [ lru_map,] 
 Func Description: This function checks the source routing for new connections.
 OPENED COMMENT END 
 */ 
__attribute__((__always_inline__)) 
...
/* 
 ...
 Update_maps: [] 
 Func Description: First check if the packet flow exists in lru_map and whether this connection is legal regarding
 its connection time(only check this if it is UDP protocol). Then we update the input real using the info from reals
 OPENED COMMENT END 
 */ 
...
/* 
 ...
 Read_maps: [] 
 Update_maps: [] 
 Func Description: Function processes the packet based on protocol and stores information in packet_description structure 
 OPENED COMMENT END 
 */ 
...
/* 
 ...
 Update_maps: [] 
 Func Description: Given input "pckt", check if its flow's dst is legal. if it does, increase the coresponding stats's amount
 OPENED COMMENT END 
 */ 
...
/* 
 ...
 Read_maps: [] 
 Update_maps: [] 
 Func Description: Function checks the input 2 backend servers have the same dst addresses
 OPENED COMMENT END 
 */ 
...
/* 
 ...
 Update_maps: [] 
 Func Description: (can't understand) find the lru_map from global cache based on gicen cpu_num,
 OPENED COMMENT END 
 */ 
...
/* 
 ...
 Read_maps: [] 
 Update_maps: [] 
 Func Description: Used for IPIP packets, Based on the encapsulate packet protocol type, 
 call the appropriate decapsulation function and decrement ttl
 OPENED COMMENT END 
 */ 
...
/* 
 ...
 Read_maps: [] 
 Update_maps: [] 
 Func Description: Used for GUE packets,Based on the encapsulate packet protocol type, 
 call the appropriate decapsulation function and decrement ttl
 OPENED COMMENT END 
 */ 
__attribute__((__always_inline__)) static inline int 
...
/* 
 ...
 Read_maps: [ stats,] 
 Update_maps: [] 
 Func Description: Function updates quic protocol stats
 OPENED COMMENT END 
 */ 
...
/* 
 ...
 Read_maps: [ stats,] 
 Update_maps: [] 
 Func Description: lookup stats by QUIC_CID_DROP_STATS, increment stats v1 by 1
 OPENED COMMENT END 
 */ 
__attribute__((__always_inline__)) static inline void
...
/* 
 ...
 Read_maps: [ stats,] 
 Update_maps: [] 
 Func Description: lookup stats by QUIC_CID_DROP_STATS, update Corresponding stats's v2
 OPENED COMMENT END 
 */ 
...
/* 
 ...
 Update_maps: [] 
 Func Description: This function process the packet based on the protocol and updates corresponding stats.
 OPENED COMMENT END 
 */ 
...
/* 
 ...
 Read_maps: [] 
 Update_maps: [] 
 Func Description: process the input ctx packet
 OPENED COMMENT END 
 */ 
SEC("xdp")
...
/* 
 ...
 Read_maps: [] 
 Update_maps: [] 
 Func Description: return the hash value of input packet
 OPENED COMMENT END 
 */ 
