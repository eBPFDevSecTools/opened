 ...
 OPENED COMMENT BEGIN 
{
  ...
  "startLine": 19,
  "endLine": 39,
  "File": "/root/examples/xdp-tutorials/common_params.c",
  "funcName": "_print_options",
  "updateMaps": [],
  "readMaps": [],
  "input": [
 ...
 OPENED COMMENT BEGIN 
{
  ...
  "endLine": 77,
  "File": "/root/examples/xdp-tutorials/common_params.c",
  "funcName": "option_wrappers_to_options",
  "updateMaps": [],
  "readMaps": [],
  "input": [
    "const struct option_wrapper *wrapper",
