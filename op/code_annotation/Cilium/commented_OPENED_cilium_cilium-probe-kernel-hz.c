...
/* 
 ...
 Read_maps: [] 
 Update_maps: [set] 
 Func Description: clear CPU and reset a specific CPU in the set, then sets the CPU affinity mask of the thread
 OPENED COMMENT END 
 */ 
...
/* 
 ...
 Read_maps: [] 
 Update_maps: [sp] 
 Func Description: reset the maxmium for the scheduling policy specified by policy 
 OPENED COMMENT END 
 */ 
...
/* 
 ...
 Read_maps: [] 
 Update_maps: [] 
 Func Description: read the timer_list file
 OPENED COMMENT END 
 */ 
...
/* 
 ...
 Read_maps: [] 
 Update_maps: [] 
 Func Description: allocate the CPU jiffies with error check (*)
 OPENED COMMENT END 
 */ 
...
/* 
 ...
 Read_maps: [] 
 Update_maps: [] 
 Func Description: fetch the CPU jiffies to fit the cpus set in current cpu parameter
 OPENED COMMENT END 
 */ 
...
/* 
 ...
 Read_maps: [] 
 Update_maps: [] 
 Func Description: decrease the fixed jiffies from the result jiffies, reset fixed jiffies to the closest kernel_hz
 stop when any fixed_jiffies isn't constant with the first one. With a macro bool for debugging 
 OPENED COMMENT END 
 */ 
...
/* 
 ...
 Read_maps: [] 
 Update_maps: [] 
 Func Description: Main function of above functions, initialize the cpu and deal with the 
 jiffies  accordingly 
 OPENED COMMENT END 
 */ 
