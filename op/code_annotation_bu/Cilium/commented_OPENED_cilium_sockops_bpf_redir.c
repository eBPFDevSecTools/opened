...
/* 
 ...
 Output: int 
 Helpers: [sk_msg_extract4_key,lookup_ip4_remote_endpoint,policy_sk_egress,msg_redirect_hash] 
 Read_maps: [msg] 
 Update_maps: [key] 
 Func Description: Store infomations about destination id, dport and sport ip4 into message, flag set to be BPF_F_INGRESS
 OPENED COMMENT END 
 */ 
__section("sk_msg")
