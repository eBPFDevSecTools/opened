...
/* 
 ...
 Output: int,
 Helpers: [redirect,map_update_elem,map_lookup_elem,tail_call,],
...
/* 
 ...
 Output: int,
 Helpers: [tail_call,fib_lookup,map_lookup_elem,],
 Read_maps: [  NODEPORT_NEIGH6,],
 Update_maps: [],
 Func Description: TO BE ADDED, 
 Commentor: TO BE ADDED (<name>,<email>) 
...
/* 
 ...
 Input: (struct  __ctx_buff *ctx, int *ifindex, int *ext_err),
 Output: int,
 Helpers: [redirect,tail_call,fib_lookup,map_lookup_elem,],
 Read_maps: [  NODEPORT_NEIGH4,],
 Update_maps: [],
 Func Description: TO BE ADDED, 
 Commentor: TO BE ADDED (<name>,<email>) 
...
/* 
 ...
 Input: (struct  __ctx_buff * ctx __maybe_unused),
 Output: int,
 Helpers: [redirect,get_socket_cookie,map_lookup_elem,],
