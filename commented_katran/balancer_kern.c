...
/* 
 ...
 Read_maps: [  ch_rings, reals,  lpm_src_v6, stats,  lpm_src_v4,],
 Update_maps: [ lru_map,],
 Func Description: TO BE ADDED, 
 Commentor: TO BE ADDED (<name>,<email>) 
 } 
...
/* 
 ...
 Output: int,
 Helpers: [get_smp_processor_id,map_lookup_elem,],
 Read_maps: [  ctl_array,  reals_stats,  stats, stats,  reals,  vip_map, lru_mapping, server_id_map,],
 Update_maps: [],
 Func Description: TO BE ADDED, 
 Commentor: TO BE ADDED (<name>,<email>) 
 } 
