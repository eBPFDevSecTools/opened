...
python3 src/annotator.py -o op/vpf-ebpf-src/txl_vpf-ebpf-src -s examples/vpf-ebpf-src -c op/vpf-ebpf-samples/commented_vpf-ebpf-src -t op/cilium/vpf-ebpf-src.function_file_list.json -u op/cilium/vpf-ebpf-src.struct_file_list.json
